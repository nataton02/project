...
console.log(str[2]);         // узнаем 2-ой индекс строки
console.log(str.toUpperCase());  // метод toUpperCase() - изменяет регистр строки в верхний
console.log(str.toLowerCase());  // метод LowerCase() - изменяет регистр строки в нижний
...
console.log(fruit.indexOf("fruit"));  //индекс заданной подстроки
console.log(fruit.indexOf("q"));

const logg = "Hello world";
console.log(logg.slice(6, 11));    //метод sclice() - обрезает заданный кусок строки
console.log(logg.slice(6));        //обрезает всю строку от заданного индекса
console.log(logg.slice(-5, -1));   //обрезает строку с права
console.log(logg.substring(0, 5)); //метод substring() - обрезает кусок строки
console.log(logg.substr(6, 5));    //метод substr() - обрезает заданное кол-во символов

const num = 12.2;
console.log(Math.round(num));      //метод Math.round()- округляет число
